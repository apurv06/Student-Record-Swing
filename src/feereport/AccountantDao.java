...
public class AccountantDao {
	public static Connection getCon(){
		...
		try{
			Class.forName("org.apache.derby.jdbc.ClientDriver");
                  //  DriverManager.registerDriver(DriverManager.getDriver("org.apache.derby.jdbc.ClientDriver"));
			con=DriverManager.getConnection("jdbc:derby://localhost:1527/feereportDB");
	...
	public static int save(Accountant a){
		...
		try{
			...
			List<Accountant> list=view();
                        int c=list.get(list.size()-1).getId()+1;
                        ps.setInt(1, c);
